...
class Wp_Post_Like {
	 ...
	 *
	 * - Wp_Post_Like_Loader. Orchestrates the hooks of the plugin.
	 * - Wp_Post_Like_i18n. Defines internationalization functionality.
	 * - Wp_Post_Like_Admin. Defines all hooks for the admin area.
	 * - Wp_Post_Like_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Wp_Post_Like_Admin( $this->get_plugin_name(), $this->get_version() );

		$this->loader->add_action( 'admin_enqueue_scripts', $plugin_admin, 'enqueue_styles' );
		$this->loader->add_action( 'admin_enqueue_scripts', $plugin_admin, 'enqueue_scripts' );

		$this->loader->add_filter( 'manage_post_posts_columns', $plugin_admin, 'ai_show_custom_column_like' );
		$this->loader->add_action( 'manage_post_posts_custom_column', $plugin_admin, 'ai_display_count_like_column', 10, 2 );
	}
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Wp_Post_Like_Public( $this->get_plugin_name(), $this->get_version() );

		$this->loader->add_action( 'wp_enqueue_scripts', $plugin_public, 'enqueue_styles' );
		$this->loader->add_action( 'wp_enqueue_scripts', $plugin_public, 'enqueue_scripts' );
		$this->loader->add_filter( 'the_title', $plugin_public, 'ai_show_title_callback' );
		$this->loader->add_action( 'wp_ajax_ai_process_like', $plugin_public, 'ai_process_like_callback' );
		$this->loader->add_action( 'wp_ajax_nopriv_ai_process_like', $plugin_public, 'ai_process_like_nologin_callback' );
